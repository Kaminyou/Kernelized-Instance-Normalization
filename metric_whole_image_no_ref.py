...
parser.add_argument(
    "--save_grad", action="store_true", help="Whether to save the gardient image"
)
...
if __name__ == "__main__":
    ...
    print(
        f"Exp::{args.exp_name}::{img_path.stem} || Grad = {sobel_gradient_avg:.4f} PIQE = {piqe_score:.4f} NIQE = {niqe_score:.4f}"
    )
